...
CREATE TABLE `query`(`sql_ID` CHAR(4) NOT NULL DEFAULT '',
		        `sql` char(255) NOT NULL DEFAULT '',
				PRIMARY KEY (`SQL_ID`)
				); 
INSERT INTO `query` VALUES('a1', 'select * from city;'); 
INSERT INTO `query` VALUES('a2', 'select * from country;'); 
INSERT INTO `query` VALUES('a3', 'select * from countrylanguage;'); 

INSERT INTO `query` VALUES('b1', 'select * from city order by id desc;'); 
INSERT INTO `query` VALUES('b2', 'select * from country order by code desc;'); 
INSERT INTO `query` VALUES('b3', 'select * from countrylanguage order by countrycode desc;'); 
INSERT INTO `query` VALUES('c1', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 2;'); 
INSERT INTO `query` VALUES('c2', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 2;'); 
INSERT INTO `query` VALUES('c3', 'select * from cy;'); 
INSERT INTO `query` VALUES('d1', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 2;'); 
INSERT INTO `query` VALUES('d2', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 20;'); 
INSERT INTO `query` VALUES('d3', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 200;'); 
INSERT INTO `query` VALUES('d4', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 2000;'); 
INSERT INTO `query` VALUES('d5', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code;'); 
INSERT INTO `query` VALUES('d6', 'select  * from countrylanguage as a join country as b on a.CountryCode = b.Code;'); 
INSERT INTO `query` VALUES('e1', 'select distinct * from city as a join country as b on a.CountryCode = b.Code;'); 
INSERT INTO `query` VALUES('e2', 'select distinct * from countrylanguage as a join country as b on a.CountryCode = b.Code limit 200;'); 

INSERT INTO `query` VALUES('q1', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 400;');
INSERT INTO `query` VALUES('q2', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 800;');
INSERT INTO `query` VALUES('q3', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 1200;');
INSERT INTO `query` VALUES('q4', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 1600;');
INSERT INTO `query` VALUES('q5', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 2000;');
INSERT INTO `query` VALUES('q6', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 2400;');
INSERT INTO `query` VALUES('q7', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 2800;');
INSERT INTO `query` VALUES('q8', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 3200;');
INSERT INTO `query` VALUES('q9', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 3600;');
INSERT INTO `query` VALUES('q10', 'select distinct * from city as a join country as b on a.CountryCode = b.Code limit 4000;');
